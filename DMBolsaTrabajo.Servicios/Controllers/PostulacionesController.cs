...
namespace DMBolsaTrabajo.Servicios.Controllers
{
    ...
    public class PostulacionesController : ControllerBase
    {
        ...
        public PostulacionesController(IPostulacionesAplicacion postulacionAplicacion, IConfiguration configuration)
        {
            _postulacionesAplicacion = postulacionAplicacion;
